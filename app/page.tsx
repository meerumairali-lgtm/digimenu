...
export default async function Home() {
  ...
  const c = {
    ...
    heroLine1: cms.hero_title_line1 || "Your restaurant's website",
    heroLine2: cms.hero_title_line2 || 'Live in minutes.',
    heroLine3: cms.hero_title_line3 || 'Not weeks.',
    heroSubtitle: cms.hero_subtitle || 'Launch a stunning website for less than the cost of a burger a month. No costly web agencies. Just 5 minutes to go live.',
    heroCta1: cms.hero_cta_primary || 'Create website for free →',
    ...
    ctaTitle: cms.cta_banner_title || 'Ready to launch your restaurant website?',
