...
const features = [
  { icon: "🔗", title: "Your own URL", desc: "Share it anywhere, print it everywhere.", image: "/features/url.png" },
  { icon: "📱", title: "QR Code included", desc: "Print, stick on table, done.", image: "/features/qr.png" },
  { icon: "🍽️", title: "Beautiful menu", desc: "4 layouts, 4 themes. Stunning on any phone.", image: "/features/menu.png" },
  { icon: "💬", title: "WhatsApp & socials", desc: "One tap to WhatsApp, Instagram, maps.", image: "/features/social.png" },
  { icon: "⚡", title: "Instant updates", desc: "Change a price — live in seconds.", image: "/features/updates.png" },
  { icon: "🌍", title: "Works worldwide", desc: "From Karachi to London to New York.", image: "/features/worldwide.png" },
]
    ...
    <section style={{ padding: "6rem 0 5rem", background: "#fff", borderTop: "1px solid #f0f0f0", borderBottom: "1px solid #f0f0f0", overflow: "hidden" }}>
      ...
      >
          ...
          return (
            <div
              ...
              style={{
                ...
                transition: transitioning ? "all 0.35s cubic-bezier(0.4,0,0.2,1)" : "all 0.35s cubic-bezier(0.4,0,0.2,1)",
                zIndex,
                opacity,
            ...
            >
              ...
              {isActive && (
                <div style={{
                  ...
                  <h3 style={{ margin: "0 0 6px", fontSize: "20px", fontWeight: 700, color: "#fff", letterSpacing: "-0.3px" }}>
                    {feature.title}
                  </h3>
        ...
        <button
          onClick={prev}
          style={{
            position: "absolute", left: "calc(50% - 220px)", zIndex: 10,
        ...
        <button
          onClick={next}
          style={{
            position: "absolute", right: "calc(50% - 220px)", zIndex: 10,
            width: "36px", height: "36px", borderRadius: "50%",
            background: "rgba(255,255,255,0.9)", border: "1px solid #e5e5e5",
            cursor: "pointer", fontSize: "18px", display: "flex",
            alignItems: "center", justifyContent: "center", color: "#333",
